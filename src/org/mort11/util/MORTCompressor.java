 ...
 * compressor.
 */
public class MORTCompressor extends SensorBase implements IDevice, LiveWindowSendable{
     ...
     */
    protected class CompressorThread extends Thread {

        MORTCompressor m_compressor;

        CompressorThread(MORTCompressor comp) {
            m_compressor = comp;
        }
     ...
     */
    public MORTCompressor(final int pressureSwitchSlot,
            final int pressureSwitchChannel,
            final int compresssorRelaySlot,
            final int compressorRelayChannel) {
     ...
     * @param compressorRelayChannel The relay channel that the compressor relay is attached to.
     */
    public MORTCompressor(final int pressureSwitchChannel, final int compressorRelayChannel) {
